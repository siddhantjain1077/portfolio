...
import { certifications, categories } from '../data/certifications.js'
  ...
  return (
    <section id="certifications" className="section">
      ...
      <p className="mt-4 max-w-2xl text-ink-1">
        Slots are ready to go — drop in AWS CLF-C02, DVA-C02, Azure AI-900, and future
        credentials here as you earn them. Edit{' '}
        <code className="chip">src/data/certifications.js</code> to update.
      </p>
      ...
      <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {filtered.map((cert, i) => (
          <motion.button
            ...
            className="glass glass-hover flex flex-col items-start p-5 text-left"
          >
            ...
            >
              ...
              <dl className="mt-5 space-y-2 text-sm">
                <div className="flex justify-between border-b border-white/5 pb-2">
                  ...
                  <dd className="text-ink-1">{active.earned ? active.date : 'Pending'}</dd>
                </div>
                <div className="flex justify-between border-b border-white/5 pb-2">
                  <dt className="text-ink-2">Credential ID</dt>
                  <dd className="text-ink-1">{active.credentialId}</dd>
                </div>
                <div className="flex justify-between pb-2">
                  <dt className="text-ink-2">Category</dt>
                  <dd className="text-ink-1">{active.category}</dd>
                </div>
              </dl>
